...
static void CriticalTableOverride() {
	...
	if (mode == 2 || mode == 3) { // bug fixes
		...
		// Ghouls
		SetEntry(4, Head,     4, StatCheck, -1);   // fo::STAT_st

		// Brahmin
		SetEntry(5, Head,     4, StatCheck, -1);   // fo::STAT_st

		// Radscorpions
		SetEntry(6, LegRight, 1, FlagsFail, fo::DAM_KNOCKED_DOWN); // 0

		SetEntry(6, LegLeft,  1, FlagsFail, fo::DAM_KNOCKED_DOWN); // 0
		SetEntry(6, LegLeft,  2, MsgFail,   5608); // 5008

		// Centaurs
		SetEntry(9, Torso,    3, FlagsFail, fo::DAM_KNOCKED_DOWN); // 0

		SetEntry(9, Uncalled, 3, FlagsFail, fo::DAM_KNOCKED_DOWN); // 0

		// Deathclaws
		SetEntry(13, LegLeft, 1, FlagsFail, fo::DAM_CRIP_LEG_LEFT); // fo::DAM_CRIP_LEG_RIGHT
		SetEntry(13, LegLeft, 2, FlagsFail, fo::DAM_CRIP_LEG_LEFT); // fo::DAM_CRIP_LEG_RIGHT
		SetEntry(13, LegLeft, 3, FlagsFail, fo::DAM_CRIP_LEG_LEFT); // fo::DAM_CRIP_LEG_RIGHT
		SetEntry(13, LegLeft, 4, FlagsFail, fo::DAM_CRIP_LEG_LEFT); // fo::DAM_CRIP_LEG_RIGHT
		SetEntry(13, LegLeft, 5, FlagsFail, fo::DAM_CRIP_LEG_LEFT); // fo::DAM_CRIP_LEG_RIGHT
