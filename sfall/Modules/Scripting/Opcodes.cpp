...
static SfallOpcodeInfo opcodeInfoArray[] = {
	...
	{0x1c1, "has_fake_perk",              op_has_fake_perk,             1, true,   0, {ARG_STRING}},
	...
	{0x255, "load_array",                 op_load_array,                1, true,  -1, {ARG_ANY}},
...
static void __fastcall defaultOpcodeHandler(fo::Program* program, DWORD opcodeOffset) { // eax/ebx - program, edx - opcodeOffset
	...
	const SfallOpcodeInfo* opcodeInfo = opcodeInfoTable[opcode - sfallOpcodeStart];
...
bool Opcodes::OpcodeExists(int opcode) {
	static const int opcodeStart = 0x8000;
