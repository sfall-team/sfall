...
VARDEFN(MessageList, inventry_message_file, _inventry_message_file)
...
VARDEFN(MessageList, proto_main_msg_file, _proto_main_msg_file)
VARDEFN(MessageList, proto_msg_files, _proto_msg_files)
