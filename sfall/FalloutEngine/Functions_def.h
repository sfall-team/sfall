...
WRAP_WATCOM_FFUNC6(long, combat_safety_invalidate_weapon_func, fo::GameObject*, source, fo::GameObject*, weapon, DWORD, hitMode, fo::GameObject*, targetA, DWORD*, safetyRange, fo::GameObject*, targetB)
...
WRAP_WATCOM_FUNC2(long, item_w_can_reload, GameObject*, weapon, GameObject*, ammo)
...
WRAP_WATCOM_FUNC2(long, item_w_skill, GameObject*, item, long, hitMode)
