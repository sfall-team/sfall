...
WRAP_WATCOM_FUNC1(bool, config_init, fo::Dictionary*, config)
WRAP_WATCOM_FUNC1(void, config_exit, fo::Dictionary*, config)
WRAP_WATCOM_FUNC3(bool, config_load, fo::Dictionary*, config, const char*, filePath, long, isDb)
WRAP_WATCOM_FUNC3(bool, config_save, fo::Dictionary*, config, const char*, filePath, long, isDb)
WRAP_WATCOM_FUNC4(bool, config_get_string, fo::Dictionary*, config, const char*, section, const char*, key, const char**, outValue)
WRAP_WATCOM_FUNC4(bool, config_set_string, fo::Dictionary*, config, const char*, section, const char*, key, const char*, value)
WRAP_WATCOM_FUNC4(bool, config_get_value, fo::Dictionary*, config, const char*, section, const char*, key, long*, outValue)
WRAP_WATCOM_FUNC5(bool, config_get_values, fo::Dictionary*, config, const char*, section, const char*, key, long*, outValues, int, count)
WRAP_WATCOM_FUNC4(bool, config_set_value, fo::Dictionary*, config, const char*, section, const char*, key, long, value)
WRAP_WATCOM_FUNC4(bool, config_get_double, fo::Dictionary*, config, const char*, section, const char*, key, float*, outValue)
WRAP_WATCOM_FUNC4(bool, config_set_double, fo::Dictionary*, config, const char*, section, const char*, key, float, value)
