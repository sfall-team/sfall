...
WRAP_WATCOM_FFUNC3(GameObject*, inven_find_type, GameObject*, critter, long, itemType, DWORD*, slot)
...
WRAP_WATCOM_FUNC2(long, item_w_anim_weap, GameObject*, item, AttackType, hitMode)
