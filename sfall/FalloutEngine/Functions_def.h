...
WRAP_WATCOM_FUNC3(long, message_find, fo::MessageList*, msgFile, long, msgNumber, DWORD*, outBuf)
...
WRAP_WATCOM_FUNC3(long, db_freadByteCount, fo::DbFile*, file, BYTE*, dest, long, count)
...
//WRAP_WATCOM_FUNC3(long, db_freadLongCount, fo::DbFile*, file, DWORD*, dest, long, count)
...
WRAP_WATCOM_FUNC3(long, xfseek, fo::DbFile*, file, long, fOffset, long, origin)
