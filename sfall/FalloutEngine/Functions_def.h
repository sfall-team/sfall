...
WRAP_WATCOM_FFUNC2(long, action_loot_container, fo::GameObject*, source, fo::GameObject*, object)
WRAP_WATCOM_FFUNC2(long, action_talk_to, fo::GameObject*, source, fo::GameObject*, target)
WRAP_WATCOM_FFUNC2(long, action_use_an_object, fo::GameObject*, source, fo::GameObject*, object)
WRAP_WATCOM_FFUNC3(long, action_use_an_item_on_object, fo::GameObject*, source, fo::GameObject*, object, fo::GameObject*, item)
WRAP_WATCOM_FFUNC3(long, action_use_skill_on, fo::GameObject*, source, fo::GameObject*, target, long, skill)
...
WRAP_WATCOM_FUNC0(void, gdialog_barter_pressed)
...
WRAP_WATCOM_FUNC2(void, mouse_set_position, long, x, long, y)
WRAP_WATCOM_FUNC3(void, mouse_simulate_input, long, deltaX, long, deltaY, long, buttons)
