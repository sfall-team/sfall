...
namespace AIpref {
	...
	enum AttackWho : long
	{
		...
		ATKWHO_whomever              = 3, // anyone, will attack the chosen target until it dies, or until retaliation occurs (combatai_check_retaliation_)
	...
	enum WeaponPref : long
	{
		...
		WEAPON_ranged                = 4,
		WEAPON_unarmed               = 5,
		WEAPON_unarmed_over_thrown   = 6, // not available for party member in control panel
