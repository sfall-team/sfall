...
#define encounter_detection(toggle)                             sfall_func1("encounter_detection", toggle)
...
#define remove_wm_town_names(toggle)                            sfall_func1("remove_wm_town_names", toggle)
...
#define set_fo1_hit_chance(toggle)                              sfall_func1("set_fo1_hit_chance", toggle)
...
#define set_reaction_thresholds(neutral, good)                  sfall_func2("set_reaction_thresholds", neutral, good)
